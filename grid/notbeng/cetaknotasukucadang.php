...
<form id="form2" name="form2" action="" method="post">
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="7"><div align="center">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="74%" rowspan="3" valign="top" class="style19b">Bengkel AUTO START</td>
            <td colspan="3"><div align="center" class="style9b">
              <div align="left" class="style19b"><strong><u>NOTA SUKU CADANG</u></strong></div>
            </div></td>
            </tr>
          <tr>
   ...
   <tr>
    ...
    <tr>
      <td width="157"><font size="2" class="style9">No.PKB</font></td>
      <td width="19"><div align="center">:</div></td>
      <td width="383" class="style9"><?=$rs['id_pkb'];?></td>
      <td width="26">&nbsp;</td>
      <td width="238" class="style9">No Rangka</td>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="tbl_dtl">
    ...
    <tr>
      ...
      <td width="166" class="style6"><div align="left">Kode Part</div></td>
      <td width="254" class="style6"><div align="left">Nama Part</div></td>
...
where id_ns='".$_GET['id']."' order by id_ns_dtl asc");
  ...
  <table width="98%" align="center">
   ...
   <tr>
     <td colspan="3"><div align="center" class="style9">Partman</div></td>
     <td colspan="3">&nbsp;</td>
     <td colspan="3"><div align="center" class="style9">SA</div></td>
   </tr>
   <tr>
     <td colspan="3">&nbsp;</td>
     <td colspan="3">&nbsp;</td>
