...
jQuery("#datagrid").jqGrid({
   	url:'grid/laporan/listlaporanpendapatan.php',
    datatype: "json",
    colNames:['PKB', 'Faktur','Nama','No Polisi','Total','Diskon','Grandtotal'],
    colModel:[ 
		...
		{name:'Diskon',index:'Diskon', width:60, align:"left",editable:true,editoptions:{size:10}}, 
		{name:'grandTotal',index:'grandTotal', width:60, align:"left",editable:true,editoptions:{size:10}}
	...
	viewrecords: true,
	editurl: 'edit.php',
	caption:"Laporan Pendapatan Service",
...
jQuery("#datagrid").jqGrid('navGrid','#navGrid',{edit:false,add:false,del:false,search:false, beforeRefresh:function(){
			...
			jQuery("#datagrid").jqGrid('setGridParam',{url:"grid/pkb/listlaporanpendapatan.php",page:1});
...
function gridReload1(){
	...
	var bb_dari = jQuery("#bb_dari").val();
	var bb_sampai = jQuery("#bb_sampai").val();
	jQuery("#datagrid").jqGrid('setGridParam',{url:"grid/laporan/listlaporanpendapatan.php?bb_dari="+bb_dari+"&bb_sampai="+bb_sampai+"&nama_plg="+nama_plg,page:1}).trigger("reloadGrid");
}
...
function viewest() 
{
	...
	var bb_dari = jQuery("#bb_dari").val();
	var bb_sampai = jQuery("#bb_sampai").val();
	window.open('grid/laporan/cetaklappendapatansvc.php?dari='+bb_dari+'&sampai='+bb_sampai,'',params);
};
</script>