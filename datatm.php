...
<head>
    ...
    <title>Data Tenaga Medis - Labkes Ungaran</title>
    <!-- Bootstrap Core CSS -->
                                ...
                                <!-- <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h2 class="h2special pull-right d-none d-md-block">Data Tenaga Medis</h1>
                                        </div> 
                                    </div>
                                </div> -->
            ...
            buttons:[
                {
                    ...
                    title: 'Data Tenaga Medis Labkes Ungaran',
                    exportOptions: {
                        columns: [0,1,2,3,4,5]
                    }
                },
