    ...
    if (!empty($_POST)) {
        ...
        if ($jum==0) {
            $insert= mysqli_query($link,"INSERT INTO ppu
                ...
                ('','$kodeppu','$namappu')");
            if ($insert) {
                header('location: datappu.php?add');
            }
            else{
                header('location: datappu.php?err');
            }
        }
        else{
...
<head>
    ...
    <title>Tambah PPU - Jakarta Ventura</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Tambah PPU</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Tambah PPU</li>
                    </ol>
                </div>
                <!-- <div>
							...
							<form action="" method="POST">
	                            <div class="card-body">
	                                ...
	                                <div class="row">
	                                	<div class="col-lg-12">
	                                		<div class="text-center text-md-left db">
			                                    ...
			                                    <h1 class="h1special pull-right d-none d-md-block">Data PPU</h1>
			                                </div> 
	                                	</div>
	                                </div>
	                                <hr>
	                                <div class="form-group row">
	                                    ...
	                                    <div class="col-lg-9">
	                                        <input class="form-control" type="text" name="kodeppu" placeholder="Masukkan Kode PPU">
	                                    </div>
	                                </div>
	                                <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label">Nama PPU</label>
	                                    <div class="col-lg-9">
	                                        <input class="form-control" type="text" name="namappu" placeholder="Masukkan Nama PPU">
	                                    </div>
	                                </div>
