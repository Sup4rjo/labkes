        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Data Katagori Tarif</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Data Katagori Tarif</li>
                    </ol>
                </div>
                <!-- <div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <a href="tambah_katagori.php">
                                    <button type="button" class="btn btn-info">Tambah Katagori Tarif</button>
                                </a>
                                <table class="table table-sm table-bordered m-t-20">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="editkatagori.php?id=<?php echo $row['id']?>">
