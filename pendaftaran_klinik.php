        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h1 class="text-themecolor">Pendaftaran Pasien Klinik</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Pendaftaran Pasien Klinik</li>
                    </ol>
                </div>
                <div> 
                                ...
                                <table class="table table-m table-bordered m-t-20 color-table primary-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="kunjungan_klinik.php?old=1&id=<?php echo $row['id']?>">
                                                    <img src="assets/images/addhp1.png" data-toggle="tooltip" data-placement="top" title="Kunjungan Pasien Lama"> 
                                                </a>

                                                <a href="edit_pasienklinik.php?id=<?php echo $row['id']?>">
        ...
        $('.table').DataTable({
            ...
            buttons:[
...

                {
                    ...
                    className: 'btn btn-sm',
                    title: 'Data Pasien Klinik',
                    messageTop: 'Daftar Pasien Klinik Labkes Ungaran',
                    exportOptions: {
                        columns: [0,1,2,3,4]
                    }
