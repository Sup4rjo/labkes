	                                ...
	                                <div class="row">
	                                	<div class="col-lg-12">
	                                		<div class="text-center text-md-left db">
			                                    ...
			                                    <h1 class="h1special pull-right d-none d-md-block">Tambah</h1>
			                                </div> 
	                                	</div>
	                                </div>
	                                <hr>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered nowrap dt" id="jaminan">
                                        ...
                                        <?php
                                            if (isset($noreg)) {
                                                # code...
                                                $sql2  = mysqli_query($link,"SELECT dj.kode_jaminan as kode_jaminan, jj.jenis_jaminan as jenis_jaminan, nama_jaminan, nilai_pasar, nilai_likuidasi, keterangan,
                                                    no_register,
                                                    dj.id as id
                                                 FROM dokjaminan dj LEFT JOIN jenisjaminan jj ON dj.jenis_jaminan=jj.id WHERE dj.no_register='$noreg'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a target="blank" href="uploadjaminan.php?kodejaminan=<?php echo $d['kode_jaminan'];?>"><button class="btn btn-sm">Upload Dokumen</button></a>
                                                    <a href="editjaminan.php?noreg=<?php echo $d['no_register'];?>"><button class="btn btn-sm">Edit</button></a>
                                                    <a href="hapusjaminan.php?id=<?php echo $d['id'];?>"><button class="btn btn-sm btn-danger">Hapus</button></a></td>
                                                </tr>
                                                <?php
                                                }
                                            }
