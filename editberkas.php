...
include_once 'ceklogin.php';
    if(!empty($_GET['id'])){
        $id=$_GET['id'];
        $sql=mysqli_query($link,"SELECT * FROM dokinvestasi NATURAL JOIN ppu WHERE id=$id");
        $e=mysqli_fetch_array($sql);
        $datajumlah=mysqli_num_rows($sql);

        $tanggal_pencairan = strtotime($e['tanggal_pencairan']);
        $tanggal_pencairan   = date("d F Y" ,$tanggal_pencairan);
        $tanggal_perjanjian = strtotime($e['tanggal_perjanjian']);
        $tanggal_perjanjian   = date("d F Y" ,$tanggal_perjanjian);
    }
    ...
    if (!empty($_POST)) {
        ...
        $update= mysqli_query($link,"UPDATE dokinvestasi SET
            no_register='$noregister',
            kode_ppu='$kodeppu',
            kode_fasilitas='$kodefasilitas',
            tanggal_pencairan='$tgl_pencairan',
            plafond='$plafond',
            no_perjanjian='$noperjanjian',
            tanggal_perjanjian='$tgl_perjanjian'
            WHERE id=$id
        ");

        if ($update) {
            header('location: databerkas.php?updated');
        }
        else{
            header('location: databerkas.php?err&id='.$id);
        }
    }
?>
<!DOCTYPE html>
							...
							<form action="" method="POST">
	                            <div class="card-body">
	                                ...
	                                <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" name="noregister" placeholder="Masukkan No Register" value="<?php echo $e['no_register'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label">Kode PPU</label>
	                                    <div class="col-lg-8">
	                                        <input class="form-control" type="text" name="kodeppu" id="kodeppu" placeholder="Masukkan Kode PPU" readonly value="<?php echo $e['kode_ppu'];?>">
	                                    </div>
	                                    <div class="col-lg-1">
	                                ...
	                                <div class="form-group row">
	                                    ...
	                                    <div class="col-lg-9">
	                                        <input class="form-control" type="text" name="namappu" id="namappu" placeholder="Masukkan Nama PPU" readonly value="<?php echo $e['nama_ppu'];?>">
	                                    </div>
	                                </div>
	                                <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label">Kode Fasilitas</label>
	                                    <div class="col-lg-8">
	                                        <input class="form-control" type="text" id="kodefasilitas" name="kodefasilitas" placeholder="Masukkan Kode Fasilitas" readonly value="<?php echo $e['kode_fasilitas'];?>">
	                                    </div>
                                        <div class="col-lg-1">
	                                ...
	                                <div class="form-group row">
	                                    ...
	                                    <div class="col-lg-9">
	                                        <input class="form-control" id="tanggal-pencairan" name="tanggalpencairan" type="text" required="" placeholder="Masukkan Tanggal Pencairan" value="<?php echo $tanggal_pencairan;?>">
	                                    </div>
	                                </div>
	                                <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label">Plafond</label>
	                                    <div class="col-lg-9">
	                                        <input class="form-control" type="text" name="plafond" placeholder="Masukkan Plafond" value="<?php echo $e['plafond'];?>">
	                                    </div>
	                                </div>
	                                <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label">No Perjanjian</label>
	                                    <div class="col-lg-9">
	                                        <input class="form-control" type="text" name="noperjanjian" placeholder="Masukkan No Perjanjian" value="<?php echo $e['no_perjanjian'];?>">
	                                    </div>
	                                </div>
	                                <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label">Tgl Perjanjian</label>
	                                    <div class="col-lg-9">
	                                        <input class="form-control" type="text" id="tanggal-perjanjian" name="tanggalperjanjian" placeholder="Masukkan Tanggal Perjanjian" value="<?php echo $tanggal_perjanjian;?>">
	                                    </div>
	                                </div>
	                            </div>
