							...
							<form action="" method="POST">
	                            <div class="card-body">
	                                ...
	                                <div class="row">
	                                	<div class="col-lg-12">
	                                		<div class="text-center text-md-left db">
			                                    ...
			                                    <h2 class="h2special pull-right d-none d-md-block">Master Data Tarif</h1>
			                                </div> 
	                                	</div>
	                                </div>
	                                <hr>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" name="kdtarif" placeholder="masukan kode tarif">
                                        </div>
                                    </div>
	                                ...
	                                <div class="form-group row">
	                                    ...
	                                    <div class="col-lg-9">
	                                        <input class="form-control" type="text" name="" placeholder="masukkan alamat">
	                                    </div>
	                                </div>
