							...
							<form action="" method="POST">
	                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Nomor Register</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="noregister" id="noregister" placeholder="Masukkan Nomor Register" readonly>
                                        </div>
                                        <div class="col-lg-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="kodeppu" class="form-control" type="text" name="keperluan" placeholder="Masukkan Kode PPU" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="namappu" class="form-control" type="text" name="tgl" placeholder="Masukkan Nama PPU" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
