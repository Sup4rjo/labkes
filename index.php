...
<head>
    ...
    <title>Dasbor - Labkes Ungaran</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Welcome to LABKES Kab. Semarang.</h3>
                </div>
                ...
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="m-b-0"><i class="mdi mdi-account-star text-info"></i></h2>
                                    <h3 class="">2456</h3>
                                    <h4 class="card-subtitle">Clinic visit today</h4></div>
                                <div class="col-12">
                                    <div class="progress">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="m-b-0"><i class="mdi mdi-account-star text-success"></i></h2>
                                    <h3 class="">546</h3>
                                    <h4 class="card-subtitle">Laboratory visit today</h4></div>
                                <div class="col-12">
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 40%; height: 6px; background:red" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h3 class="">$24561</h3>
                                    <h4 class="card-subtitle">Clinic income today</h4></div>
                                <div class="col-12">
                                    <div class="progress">
                    ...
                    <div class="card card-success">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="m-b-0"><i class="mdi mdi-account-multiple text-warning"></i></h2>
                                    <h3 class="">$30010</h3>
                                    <h4 class="card-subtitle" style="color:red;">Laborat income today</h4></div>
                                <div class="col-12">
                                    <div class="progress">
