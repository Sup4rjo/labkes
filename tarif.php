...
<head>
    ...
    <title>Master Data Tarif - Labkes Ungaran</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Form Master Data Tarif</h3>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h2 class="h2special pull-right d-none d-md-block">Data Tarif</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                                <a href="tambah_tarif.php">
                                    <button type="button" class="btn btn-info">Tambah Data Tarif</button>
                                </a>
                                <table class="table table-m table-bordered m-t-20">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql="SELECT k.*, p.nama_produk FROM komponen_tarif k LEFT JOIN produk_tarif p on k.kode_produk=p.kode_produk";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['lainya']?></td>
                                           
                                            
                                                

                                            <td>
                                                <a href="edit_tarif.php?id=<?php echo $row['id']?>">
        ...
        $('.table').DataTable({
            ...
            buttons:[
...

                {
                    ...
                    text:'Export to PDF',
                    className: 'btn btn-sm',
                    title: 'Data Katagori Tarif Labkes Ungaran',
                    exportOptions: {
                        columns: [0,1,2,3,4,5,6,7]
                    }
                },

                {
                    ...
                    messageTop: 'Data Komponen Tarif Labkes Ungaran',
                    exportOptions: {
                        columns: [0,1,2,3,4,5,6,7]
                    }
                }
