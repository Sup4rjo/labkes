...
<head>
    ...
    <title>Hasil Pemeriksaan Klinik - Labkes Ungaran</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Menu Hasil Pemeriksaan Klinik</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Menu Pemeriksaan Klinik</li>
                    </ol>
                </div>
                <!-- <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h2 class="h2special pull-right d-none d-md-block">Entry Hasil Pemeriksaan Klinik</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                                <a href="tambah_pasienklinik.php">
                                    <button type="button" class="btn btn-info">Pasien Baru</button>
                                </a>
                                <a href="tambah_pasienklinik.php">
                                    <button type="button" class="btn btn-danger">Batal Periksa</button>
                                </a>
                                <a href="tambah_pasienklinik.php">
                                    <button type="button" class="btn btn-warning">Informasi</button>
                                </a>
                                <a href="tambah_pasienklinik.php">
                                    <button type="button" class="btn btn-good">Print Hasil</button>
                                </a>
                                ...
                                <table class="table table-m table-bordered m-t-20 ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="entry_hasil_klinik.php?id=<?php echo $row['id']?>">
                                                    <!-- <button style="" class="icon-pencil" data-toggle="tooltip" data-placement="top" title="Edit data"></button> -->
                                                 <div class="preview"> <i class="icon-plus" data-toggle="tooltip" data-placement="top" title="Entry Hasil Pemeriksaan"></i></div>
                                                </a>
            ...
            buttons:[
                {
                    ...
                    title: 'Daftar Pemeriksaan Pasien Klinik Dalam Proses',
                    exportOptions: {
                        columns: [0,1,2,3,4]
                    }
                },
...

                {
                    extend: 'print',
                    className: 'btn btn-sm',
                    title: 'Data pasien klinik dalam proses pemeriksaan',
                    messageTop: 'Daftar Pemeriksaan Pasien Klinik Dalam Proses',
                    exportOptions: {
                        columns: [0,1,2,3,4]
                    }
