        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Data Nilai Normal</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Data Nilai Normal</li>
                    </ol>
                </div>
                <!-- <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <!-- <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h2 class="h2special pull-right d-none d-md-block">Data Nilai Normal</h1>
                                        </div> 
                                    </div>
                                </div> -->
                                <hr>
                                <a href="tambah_nilainormal.php">
                                    <button type="button" class="btn btn-info">Tambah Nilai Normal</button>
                                </a>
                                <table class="table table-m table-bordered m-t-20">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql="SELECT * FROM komponen_tarif k LEFT JOIN produk_tarif p on k.kode_produk=p.kode_produk";
            ...
            buttons:[
                {
                    ...
                    title: 'Data Nilai Normal / Nilai Baku',
                    exportOptions: {
