...
// end 
    ...
    if (!empty($_POST)) {
        ...
        if ($update) {
            // echo "sukses";
            header('location: verifikasi.php?updated');
        }
        else{
            //echo $sqlupdate;
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Verifikasi Hasil Pemeriksaan</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Verifikasi Hasil Pemeriksaan</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h3 class="card-title">Verifikasi Hasil Pemeriksaan</h3>
                                            <div class="row">
                                                <div class="col-lg-6">
                                ...
                                <table class="table table-m table-bordered m-t-20 color-table inverse-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="hasil[]" readonly type="text" value="<?php echo $data2['hasil_pemeriksaan'];?>">
                                            </td>
                                            <td>
                                                <input name="keterangan[]" readonly type="text" value="<?php echo $data2['keterangan'];?>">
                                            </td>
                                        </tr>
                                        <?php
                                            }
                                ...
                                <div class="card-footer">
	                               <div class="row">
	                                    <div class="col-md-12">
                                            <button type="button" onclick="kembali()" class="btn btn-danger"><i class="fa fa-close"></i> Batal</button>
	                                        <button type="submit" class="btn btn-info"><i class="fa fa-check"></i> Verifikasi</button>
                                            <button type="button" class="btn btn-warning"><i class="fa fa-unlock"></i> UnLock</button>
	                                    </div> 
	                                </div> 
                                </div>
                                </form>
