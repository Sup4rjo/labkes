...
error_reporting(1);
  ...
  $id_kunjungan = $_GET['id'];
	$sql2 = "UPDATE kunjungan_klinik
        ...
        if ($update) {
            // header('location: pemeriksaan_klinik.php?');
        }
?>
...
<form id="form2" name="form2" action="" method="post">
    ...
    <tr>
      <td colspan="7"><div align="center">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" valign="top" class="style19b"><div align="center">HASIL LABORATORIUM KLINIK</div></td>
          </tr>
          
          <tr>
            <td width="100%" class="style9"><div align="center">Nomor: KLN/120320/00001</div></td>
            <!-- <td width="1%" class="style9"><div align="center">:</div></td> -->
            <!-- <td width="14%" class="style9"><div align="center">KLN/120320/00001</div></td> -->
          </tr>
          <tr>
            <td width="100%" class="style9"><div align="center">Tanggal: <?=date_format(date_create($rs['tgl_ns']),'d-m-Y');?></div></td>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="tbl_dtl">
    ...
    <tr>
      ...
      <td width="50" class="style6"><div align="left">Kode</div></td>
      <td width="254" class="style6"><div align="left">Jenis Pemeriksaan</div></td>
      <td width="50" class="style6"><div align="center">Nilai Normal</div></td>
      <td width="50" class="style6"><div align="center">Hasil Pemeriksaan</div></td>
      <td width="120" class="style6"><div align="center">Keterangan</div></td>
    </tr>
      <tr>
      <td colspan="7">
      <hr />      </td>
  ...
  // echo $tt['qty'];
	...
	{	
      ...
      <tr>
        ...
        <td class="style9"><div align="left"><?=$rs1['kode_produk'];?></div></td>
        <td class="style9"><div align="left"><?=$rs1['nama_produk'];?></div></td>
        <td class="style9"><div align="center"><?=$rs1['qty'];?></div></td>
        <td class="style9"><div align="center"><?=number_format($rs1['totalharga'],2);?></div></td>
        <td class="style9"><div align="left"><?=number_format($rs1['total'],2);?></div></td>
      </tr>
      <?php
  ...
  <table width="98%" align="center">
    ...
    <tr>
      ...
      <!-- <td width="15">&nbsp;</td> -->
      <td width="471"><div class="style9" id="terbilang"></div></td>
      <td width="44">&nbsp;</td>
      <td width="47" class="st_total"></td>
...
window.print();
window.location.href("pemeriksaan_klinik.php");	
