...
if (!empty($_POST)) {
    ...
    $sqlkunjungan .= "INSERT INTO `kunjungan_klinik`( `tgl_kunjungan`, `no_rm`, `no_kunjungan`, `pasien_lama`) VALUES (NOW(), '$koderm', '$nokunjungan', '$pasienlama')";
    $sqlproduk .= "INSERT INTO `transaksi_klinik`( `id_kunjungan`, `kode_tarif`, `qty`, `total`) VALUES ";
    ...
    if ($hasilproduk) {
        header('location: nota_klinik.php?id='.$idkunjungan);
    }
    //var_dump($_POST);
