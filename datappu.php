...
<head>
    ...
    <title>Data PPU - Jakarta Ventura</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Data PPU</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Data PPU</li>
                    </ol>
                </div>
                <!-- <div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <a href="tambahppu.php">
                                    <button type="button" class="btn btn-info">Tambah PPU</button>
                                </a>
        ...
        $('.table').DataTable({
            ...
            buttons:[
                ...
                },
                {
                    ...
                    className: 'btn btn-sm',
                    title: 'Data PPU',
                    messageTop: 'Daftar PPU yang terdaftar di Jakarta Ventura',
                    exportOptions: {
                        columns: [0,1]
                    }
                }
