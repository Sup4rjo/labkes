        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Menu Pendaftaran Klinik</h3>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h2 class="h2special pull-right d-none d-md-block">Pendaftaran Klinik</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                                <a href="tambahdtm.php">
                                    <button type="button" class="btn btn-info">Tambah Data Tenaga Medis</button>
                                </a>
