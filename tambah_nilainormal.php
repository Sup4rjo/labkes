<?php
    ...
    if (!empty($_POST)) {
        ...
        if ($jum==0) {
            ...
            if ($insert) {
                header('location: nilainormal.php?add');
            }
            else{
            ...
            header('location: nilainormal.php?err=already');
        }
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Data Nilai Normal - Labkes Ungaran</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Tambah Nilai Normal</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Tambah Nilai Normal</li>
                    </ol>
                </div>
                <!-- <div>
                        ...
                        <div class="card">
							<form action="" method="POST">
	                            <div class="card-body">
	                                ...
	                                <div class="row">
	                                	<div class="col-lg-10">
	                                		<div class="text-center text-md-left db">
			                                    ...
			                                    <h1 class="h1special pull-right d-none d-md-block">Data Nilai Normal</h1>
			                                </div> 
	                                	</div>
	                                </div>
	                                <hr>
	                                <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label" style="font-weight: bold;">Parameter **</label>
	                                    <div class="col-lg-8">
	                                ...
	                                <div class="form-group row">
	                                    <label for="example-text-input" class="col-lg-3 col-form-label" style="font-weight: bold;">Metodelogi **</label>
	                                    <div class="col-lg-8">
	                                        <div class="input-group">

                                                <input class="form-control" type="text" name="metodelogi" id="id_metodelogi" placeholder="">
                                                <input class="form-control" type="text" name="nama_metode" id="id_nama_metode" placeholder="">
                                                <button type="button" data-toggle="modal" data-target="#modal_tarif" class="btn">. . .</button>
                                            </div>
	                                    </div>
	                                </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-lg-3 col-form-label" style="font-weight: bold;">Nilai Normal</label>
                                        <div class="col-lg-3">
                                            <input class="form-control" type="text" name="nilai_normal" placeholder="masukan nilai normal">
                                        </div>
                                    </div>
