...
<head>
    ...
    <title>Historical Pemeriksaan Klinik - Labkes Ungaran</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Historical Pemeriksaan Klinik</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Historical Pemeriksaan Klinik</li>
                    </ol>
                </div>
                <!-- <div>
