...
include_once 'ceklogin.php';
    ...
    if (!empty($_POST)) {
        ...
        if (isset($kodejaminan)) {
            # code...
            $sqlcek  = mysqli_query($link,"SELECT * FROM dokjaminan WHERE dokjaminan.kode_jaminan='$kodejaminan'");
        ...
        if ($datacek) {
            ...
            // if everything is ok, try to upload file
                ...
                if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
                    ...
                    $tambahdata= mysqli_query($link, "INSERT INTO filejaminan
                        VALUES 
                        ('','$kodejaminan','$jenisdokumen','$namaberkas')");
                    if ($tambahdata) {
                        # code...
...
<head>
    ...
    <title>Upload Dokumen Jaminan - Jakarta Ventura</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Upload Dokumen Jaminan</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Upload Dokumen Jaminan</li>
                    </ol>
                </div>
                <!-- <div>
							...
							<div class="card-body">
								...
								<form action="">
									<div class="form-group row">
		                                <div class="col-lg-6">
											<div class="row">
												<a data-toggle="collapse" href="#tabeljam" role="button" aria-expanded="false" aria-controls="collapseExample" class="col-lg-4 col-form-label">Kode Jaminan</a>
				                                <div class="col-lg-8">
				                                    <input class="form-control" type="text" id="kodejaminan" name="kodejaminan" placeholder="Masukkan Kode Jaminan">
				                                </div>
											</div>			    
		                                </div>
		                                <div class="col-lg-6">
                                            <button type="button" data-toggle="modal" data-target="#modaljaminan" class="btn">. . .</button>
								...
								<div class="collapse" id="tabeljam">
											...
											<tbody>
												<tr>
                                                    <?php
                                                        ...
                                                        if (isset($kodejaminan)) {
                                                            # code...
                                                            $sql = mysqli_query($link,"SELECT dokjaminan.*, jenisjaminan.jenis_jaminan as jenis FROM dokjaminan LEFT JOIN jenisjaminan ON dokjaminan.jenis_jaminan=jenisjaminan.id WHERE kode_jaminan='$kodejaminan'");
                        ...
                        <div class="card">
							<form action="" method="POST" enctype="multipart/form-data">
	                            <div class="card-body">
	                                ...
	                                <div class="form-group row">
                                        <label for="example-text-input" class="col-lg-5 col-form-label">Jenis Dokumen</label>
                                        <div class="col-lg-7">
                                            <select id="jenisdokinv" name="jenisdokumen" class="pmd-select2 select-with-search form-control custom-select">
                                                <option>Pilih Jenis Dokumen</option>
                                                <?php  
                                                    $sql=mysqli_query($link, "SELECT * FROM jenisdokjaminan");
							...
							<div class="card-body">
								<div class="row">
                                	<div class="col-lg-12">
                                		<div class="text-center text-md-left db">
		                                    <img src="assets/images/jakvent.png" class="logospecial">
		                                    <h1 class="h1special pull-right d-none d-md-block">Dokumen Jaminan</h1>
		                                </div> 
                                	</div>
                                </div>
                                <hr>
                                <div class="table-responsive">
                                	<table class="table table-bordered nowrap dt">
                                		<thead>
                                			<!-- <th>No Register</th> -->
                                			<th>Jenis</th>
                                			<th>File PDF</th>
                                		...
                                		<tbody>
                                            ...
                                            if (isset($kodejaminan)) {
                                                # code...
                                                $sql2  = mysqli_query($link,"SELECT f.filename as filename, j.jenis_dokumen as jenis_dokumen,f.id FROM filejaminan f LEFT JOIN jenisdokjaminan j ON f.jenis_dokumen=j.id WHERE f.kode_jaminan='$kodejaminan'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="hapusberkasjam.php?id=<?php echo $d['id']?>">
    ...
    <script>
        ...
        $(document).on('click', '.pilihjaminan', function (e) {
            document.getElementById("kodejaminan").value = $(this).attr('data-kodejaminan');
