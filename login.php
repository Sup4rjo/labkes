...
<head>
    ...
    <!-- Favicon icon -->
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicon-demak.png">
    <title>Login - Jakarta Ventura</title>
    <!-- Bootstrap Core CSS -->
          ...
          ">
            <div class="login-box card">
                <div class="card-body">
                	...
                	<a href="javascript:void(0)" class="text-center m-b-20 db"><img height="100px" src="assets/images/jakvent.png" alt="Home" /><!-- <br/><img height="50px" src="assets/images/text-center.png" alt="Home" /> --></a>
                    <?php 
                        if (isset($_GET['k'])) {
                            ?>
